...
class MainActivity : AppCompatActivity(R.layout.activity_main) {
    ...
    private fun createImage() {
        db.imageDao().insert(Image("idImage", "http://someuri.com/idProfessional", "1"))
    }
}
